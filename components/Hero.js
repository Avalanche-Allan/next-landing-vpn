          ...
          {listUser.map((listUsers, index) => (
            ...
            >
              <div className="flex mx-auto w-40 sm:w-auto">
                <div className="flex items-center justify-center bg-[var(--mountain-snow)] w-12 h-12 mr-6 rounded-full">
                  <img src={listUsers.icon} className="h-6 w-6" />
                </div>
                <div className="flex flex-col">
                  <p className="text-xl text-[var(--sherpa-blue)] font-bold font-inter">
                    {listUsers.number}+
                  </p>
                  <p className="text-lg text-[var(--sherpa-blue)] font-sourceSansPro">
                    {listUsers.name}
                  </p>
                </div>
              </div>
